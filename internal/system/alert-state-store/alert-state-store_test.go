...
func TestInMemoryAlertStateStore_IncrementCount(t *testing.T) {
	...
	val, err := store.IncrementCount(context.Background(), model.AlertTypeHighCPU, model.ConditionHigh)
	if err != nil {
		t.Fatal(err)
	}
	...
	val, err = store.IncrementCount(context.Background(), model.AlertTypeHighCPU, model.ConditionNormal)
	if err != nil {
		t.Fatal(err)
	}
...
func TestInMemoryAlertStateStore_IncrementCount_InvalidType(t *testing.T) {
	...
	_, err := store.IncrementCount(context.Background(), model.AlertType("UNKNOWN"), model.ConditionHigh)
	if err == nil {
...
func TestInMemoryAlertStateStore_SetActive(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := store.SetActive(context.Background(), model.AlertTypeHighCPU, tt.want)
			if err != nil {
				t.Fatal(err)
			}
...
func TestInMemoryAlertStateStore_SetActive_ValueChanging(t *testing.T) {
	...
	err = store.SetActive(context.Background(), model.AlertTypeHighCPU, true)
	if err != nil {
		t.Fatal(err)
	}
